            ...
            <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 md:gap-6 auto-rows-[200px] md:auto-rows-[250px]">
                    {mainCategory.images.map((image, index) => {
                        const layoutClass = clothLayouts[Math.min(mainCategory.images!.length, 6) as keyof typeof clothLayouts]?.[index % clothLayouts[Math.min(mainCategory.images!.length, 6) as keyof typeof clothLayouts].length] || "col-span-1 row-span-1";
